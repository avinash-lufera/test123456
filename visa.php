<?php include './partials/layouts/layoutTop.php'; ?>
    ...
    <body>
        ...
        <div class="search-card bg-base">
            ...
            <input type="text" id="searchInput" placeholder="Search Visa..." />
            </div>
            <a href="view-visa.php" class="add-btn">+ Add New Visa</a>
        </div>
        ...
        <!-- <div class="list-section" id="websiteList"> -->
            ...
            if ($status === 'approved') {
                ...
                <div class="list-item bg-base <?php echo $statusClass; ?>">
                    ...
                    <a href="visa-det.php?website_id=<?php echo (int)$site['id']; ?>" class="dashboard-btn">Manage</a>
                    </div>
                </div>
                <?php endforeach; ?>
            <?php endif; ?>
